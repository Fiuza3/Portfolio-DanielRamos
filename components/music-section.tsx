...
export default function MusicSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="min-h-screen bg-background py-20 px-4 md:px-8 lg:px-16"
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground font-serif max-w-2xl mx-auto">
            Descubra as canções que tocam o coração e fortalecem a fé. Ouça nas
