      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 lg:px-16 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-muted-foreground">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-serif">danielramosdunamis@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                ...
                <span className="font-serif">(31) 98897-9635</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                ...
                <span className="font-serif">Belo Horizonte, MG </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/danielramosbh/"
        ...
        <div className="border-t border-border pt-8">
          ...
          <div className="text-center text-muted-foreground font-serif text-sm">
            <p className="mt-2 text-xs opacity-70">© 2025 Marcus Fiuza. Todos os direitos reservados.</p>
          </div>
        </div>
      </div>
    </footer>
